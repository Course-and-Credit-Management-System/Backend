...
response = requests.get('http://localhost:8001/api/v1/admin/students', headers={'Cookie': 'access_token=test'})
if response.status_code == 200:
    ...
    if students and len(students) > 0:
        ...
        update_response = requests.post(
            ...
            json={'major': 'SE'},
            headers={'Content-Type': 'application/json', 'Cookie': 'access_token=test'}
        )
